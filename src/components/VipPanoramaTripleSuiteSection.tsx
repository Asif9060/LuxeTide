...
interface VipPanoramaTripleSuiteSectionProps {
  shipName: string;
  suiteTitle: string;
  description: string;
  highlights: string[];
...
export default function VipPanoramaTripleSuiteSection({
  shipName,
  suiteTitle,
  description,
  highlights,
  bookingInclusions,
  bookingNotes
}: VipPanoramaTripleSuiteSectionProps) {
  return (
        ...
        >
          <div className="space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-heading text-white">
              VIP Panorama Triple Suites | Air-Conditioned Luxury Cabins | Attached Private Bathrooms | Swimming Pool | Fully-Equipped Gym | Wellness Spa | Separate Prayer Rooms | Elegant Dining Area | 24-Hour Room Service | Emergency Medical Supplies | Unlimited Tea &amp; Coffee | Unlimited Mineral Water | Soothing Background Music | Carpeted Interiors | Children&apos;s Playground.
            </h2>
