...
interface PanoramaDeluxeSuiteSectionProps {
  shipName: string;
  suiteTitle: string;
  description: string;
  highlights: string[];
...
export default function PanoramaDeluxeSuiteSection({
  shipName,
  suiteTitle,
  description,
  highlights,
  bookingInclusions,
  bookingNotes
}: PanoramaDeluxeSuiteSectionProps) {
  return (
        ...
        >
          <div className="space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-heading text-white">
              Panorama Triple Suites | Air-Conditioned Luxury Cabins | Attached Private Bathrooms | Swimming Pool | Fully-Equipped Gym | Wellness Spa | Separate Prayer Rooms | Elegant Dining Area | 24-Hour Room Service
            </h2>
